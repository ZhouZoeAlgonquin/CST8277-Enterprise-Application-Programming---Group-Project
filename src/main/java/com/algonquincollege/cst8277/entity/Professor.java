...
@NamedQueries({
		@NamedQuery(name = Professor.ALL_PROFESSORS_QUERY, query = "SELECT DISTINCT p FROM Professor p LEFT JOIN FETCH p.courseRegistrations cr LEFT JOIN FETCH cr.student LEFT JOIN FETCH cr.course")
})
