...
public class ProfessorController implements Serializable, MyConstants {
    ...
    protected List<String> listOfDegrees;
    ...
    public String updateProfessor(Professor professor) {
        Response response = webTarget
        		.register(auth)
                .path(PROFESSOR_RESOURCE_NAME + RESOURCE_PATH_ID_PATH.replace("{" + RESOURCE_PATH_ID_ELEMENT + "}", String.valueOf(professor.getId())))
                .request()
    ...
    public String deleteProfessor(int professorId) {
        Response response = webTarget
        		.register(auth)
                .path(PROFESSOR_RESOURCE_NAME + RESOURCE_PATH_ID_PATH.replace("{" + RESOURCE_PATH_ID_ELEMENT + "}", String.valueOf(professorId)))
                .request()
                .get();
        ...
        if (professorToBeDeleted != null) {
        	response = webTarget     	
                    .register(auth)
                    .path(PROFESSOR_RESOURCE_NAME + RESOURCE_PATH_ID_PATH.replace("{" + RESOURCE_PATH_ID_ELEMENT + "}", String.valueOf(professorToBeDeleted.getId())))
                    .request()
                    .delete();
    ...
    public List<String> getDegrees() {
    	Response response = webTarget
                .register(auth)
                .path(PROFESSOR_RESOURCE_NAME + DEGREE_RESOURCE_PATH)
                .request()
                .get();
        listOfDegrees = response.readEntity(new GenericType<List<String>>(){});
