/********************************************************************************************************
 * File:  ProfessorAssignmentController.java
...
@Named("professorAssignmentController")
@SessionScoped
public class ProfessorAssignmentController implements Serializable, MyConstants {
    ...
    public ProfessorAssignmentController() {
    	super();
    }
    ...
    public List<Professor> getProfessors() {
        if (listOfProfessors == null) {
            ...
            listOfProfessors = professorController.getProfessors();
        }
        return listOfProfessors;
    }

    public String assignProfessor(CourseRegistration registration, Professor professor) {
    ...
    public String refreshProfessorAssignmentForm() {
