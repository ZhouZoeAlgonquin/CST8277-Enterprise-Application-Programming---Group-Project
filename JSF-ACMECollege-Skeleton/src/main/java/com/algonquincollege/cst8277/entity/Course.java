...
@NamedQueries({
		@NamedQuery(name = Course.ALL_COURSES_QUERY, query = "SELECT DISTINCT c FROM Course c LEFT JOIN FETCH c.courseRegistrations cr LEFT JOIN FETCH cr.student")
})
// Course inherits id/created/updated/version from PojoBase
public class Course extends PojoBase implements Serializable {
	...
	public String toString() {
		...
		builder.append("Course[id = ").append(id).append(", courseCode = ").append(courseCode)
				.append(", courseTitle = ")
