...
public class ACMECollegeService implements Serializable {
    ...
    public CourseRegistration updateCourseRegistrationByStudentAndCourse(int studentId, int courseId,
        ...
        if (registration != null) {
            ...
            if (registrationWithUpdates.getProfessor() != null) {
                registration.setProfessor(registrationWithUpdates.getProfessor());
            }
            if (registrationWithUpdates.getLetterGrade() != null) {
